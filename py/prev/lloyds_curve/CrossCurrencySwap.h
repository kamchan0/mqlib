...
*****************************************************************************/
#ifndef __LIBRARY_PRICERS_FLEXYCF_CROSSCURRENCYSWAP_H_INCLUDED
#define __LIBRARY_PRICERS_FLEXYCF_CROSSCURRENCYSWAP_H_INCLUDED
#pragma once
...
namespace FlexYCF
{
    ...
    class CrossCurrencySwap : public CalibrationInstrument
    {
    public:
		CrossCurrencySwap(const string& description,
        ...
        /// Creates the cross-Currency swaps
        ...
        {
            return CrossCurrencySwap::getName();
        }
		...
		virtual void accumulateGradientDependentModel(BaseModel const& modelFor, BaseModel const& modelDom,
                                        double multiplier, 
                                        GradientIterator gradientBegin, 
                                        GradientIterator gradientEnd);
    ...
    protected:
        CrossCurrencySwap(CrossCurrencySwap const& original, CloneLookup& lookup);
    ...
    private:
        ...
        CrossCurrencySwap(CrossCurrencySwap const&); // deliberately disabled as won't clone properly
        ...
        double fxRate(const BaseModel& model) const
        {
            return m_fxSpot * m_fxSpotDomDiscountFactor->getValue(model)/m_fxSpotForDiscountFactor->getValue(*m_foreignModel);
        }
        ...
        MultiCcyFloatingLegPtr					m_resettableForeignLeg;
        mutable BaseModelConstPtr               m_foreignModel;
        mutable LT::Str                         m_foreignCcy;
		mutable LT::Str                         m_foreignMarket;
        ...
        bool                                    m_singleCurrencyBasisSwap;

        Gradient m_tmpGradient;
    };  //  CrossCurrencySwap
    
    DECLARE_SMART_PTRS( CrossCurrencySwap )

}   //  FlexYCF
#endif //__LIBRARY_PRICERS_FLEXYCF_CROSSCURRENCYSWAP_H_INCLUDED