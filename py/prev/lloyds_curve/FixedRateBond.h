...
#ifndef __LIBRARY_PRICERS_FLEXYCF_FIXEDRATEBOND_H_INCLUDED
#define __LIBRARY_PRICERS_FLEXYCF_FIXEDRATEBOND_H_INCLUDED
...
namespace FlexYCF
{
	class FixedRateBondInstrument : public CalibrationInstrument
	{
	public:
		FixedRateBondInstrument(	const double rate,
	...
	protected:
		FixedRateBondInstrument(FixedRateBondInstrument const& original, CloneLookup& lookup);
	...
	private:
		...
		FixedRateBondInstrument(FixedRateBondInstrument const&); // disabled the copy constructor
	...
	DECLARE_SMART_PTRS( FixedRateBondInstrument )
}
