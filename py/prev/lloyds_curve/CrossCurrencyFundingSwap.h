#ifndef __LIBRARY_PRICERS_FLEXYCF_CROSSCURRENCYFUNDINGSWAP_H_INCLUDED
#define __LIBRARY_PRICERS_FLEXYCF_CROSSCURRENCYFUNDINGSWAP_H_INCLUDED
#pragma once
...
namespace FlexYCF
{
    ...
    class CrossCurrencyFundingSwap : public CalibrationInstrument
    {
    public:
		CrossCurrencyFundingSwap(const string& description,
        ...
        {
            return CrossCurrencyFundingSwap::getName();
        }
    ...
    protected:
        CrossCurrencyFundingSwap(CrossCurrencyFundingSwap const& original, CloneLookup& lookup);
    ...
    private:
        ...
        CrossCurrencyFundingSwap(CrossCurrencyFundingSwap const&); // deliberately disabled as won't clone properly
    ...
    DECLARE_SMART_PTRS( CrossCurrencyFundingSwap )
