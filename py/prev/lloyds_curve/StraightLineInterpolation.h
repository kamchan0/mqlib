...
*****************************************************************************/
#ifndef __LIBRARY_PRICERS_FLEXYCF_STRAIGHTLINEINTERPOLATION_H_INCLUDED
#define __LIBRARY_PRICERS_FLEXYCF_STRAIGHTLINEINTERPOLATION_H_INCLUDED
#pragma once
...
namespace FlexYCF
{
    /// StraightLineInterpolation represents continuous
    ...
    /// this formula.
    /// Moreover f(x) = x[0] for x < 0 and f(x) = y[N] for x >= x[N]
    class StraightLineInterpolation: public InterpolationMethod
    {
    public:
    ...
    DECLARE_SMART_PTRS( StraightLineInterpolation )

}   // FlexYCF
#endif //__LIBRARY_PRICERS_FLEXYCF_STRAIGHTLINEINTERPOLATION_H_INCLUDED